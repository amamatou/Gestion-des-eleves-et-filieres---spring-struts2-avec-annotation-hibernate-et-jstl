...
<html lang="en">
  <head>
    ...
    <title>Modifier eleve - GesFil</title>
              ...
              <div class="col-12">
                <div class="card">
                  <div class="card-header">
                    <h4 class="card-title">Modifier un eleve</h4>
                  </div>
                  <div class="card-content">
                    <div class="card-body">
                        <s:actionerror/>
                      <s:form action="updateEleve" method="post" cssClass="form form-vertical">
                        <div class="form-body">
                          <div class="row">
                            <div class="col-12">
                              <div class="form-group">
                                <s:textfield name="eleve.cne" label="CNE" cssClass="form-control" readonly="true"/>
                              </div>
                            </div>
                              <div class="col-12">
                              <div class="form-group">
