...
<html lang="en">
  <head>
    ...
    <title>Ajout de filiere - GesFil</title>
              ...
              <div class="col-12">
                <div class="card">
                  <div class="card-header">
                    <h4 class="card-title">Ajout de Filiere</h4>
                  </div>
                  <div class="card-content">
                    <div class="card-body">
                      <s:form action="createFiliere" method="post" cssClass="form form-vertical">
                        <div class="form-body">
                          <div class="row">
                            <div class="col-12">
                              <div class="form-group">
                                <s:textfield name="filiere.code_Fil" label="Code" cssClass="form-control" />
                              </div>
                            </div>
                            <div class="col-12">
                              <div class="form-group">
